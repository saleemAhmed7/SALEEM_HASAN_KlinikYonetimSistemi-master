...
namespace Clinic_Management_System
{
    public partial class Visits : Form
    {
        ...
        private void listBox1_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lütfen bir ziyaret seçin!");
                return;
            }
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lütfen nedenleri ve tanıyı girin!");
                return;
            }
            ...
            if (command.ExecuteNonQuery() > 0)
                MessageBox.Show("Ziyaret eklendi!");
            else
                MessageBox.Show("Ziyaret eklenemedi!");
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Lütfen nedenlerini ve teşhisini giriniz!");
                return;
            }
