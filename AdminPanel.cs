...
namespace Clinic_Management_System
{
    public partial class AdminPanel : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            if(!validateInputs())
            {
                MessageBox.Show("Lütfen giriş alanlarını tekrar kontrol edin!");
                return;
            }
            ...
            {
                //Kullanıcı tablosunda kaydı oluşturma
                ...
                if (command.ExecuteNonQuery() > 0)
                {
                    ...
                    MessageBox.Show("Hesap oluşturulurken hata oluştu!");
            }
            else
                MessageBox.Show("Hesap oluşturulurken hata oluştu!");
            con.Close();
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            ...
            if (command.ExecuteNonQuery() > 0)
                ...
                MessageBox.Show("Hesap silinmedi!");
            con.Close();
            updateList("");
            textBox6.Clear();
            textBox7.Clear();
